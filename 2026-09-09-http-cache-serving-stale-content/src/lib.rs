...
fn run(log: &mut String, request: &http_incoming::Request) -> Result<(), String> {
    ...
    // <fold the ordinary path: send, prepare, dispatch, covered last time>
...
impl http_incoming::Guest for ServingStaleContent {
...
// </fold>
bindings::export!(ServingStaleContent with_types_in bindings);
